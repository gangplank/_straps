...
function _strapstraps_custom_header_setup() {
	$args = array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => '_straps_header_style',
		'admin-head-callback'    => '_straps_admin_header_style',
		'admin-preview-callback' => '_straps_admin_header_image',
	);

	$args = apply_filters( '_straps_custom_header_args', $args );
...
add_action( 'after_setup_theme', '_straps_custom_header_setup' );
...
if ( ! function_exists( '_straps_header_style' ) ) :
/**
